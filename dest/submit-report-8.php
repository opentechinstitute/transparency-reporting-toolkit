...
<form name="submitSection8" method="post" action="submit-report-9.php">
...
<table>
  ...
  <tbody>
    <tr class="disabled">
      ...
      <td>
        <input type="text" name="all-orders-total" disabled="true" value=0></input>
      </td>
    </tr>
    <tr class="disabled">
      <td>
  ...
  <span style="width:69.3%"></span>
</div>
<div class="progress-buttons">
  <a href="submit-report-7.php" class="progression ">&lt; Back</a>
  <input type="submit" class="progression" name="save-section-8" value="Next >" id="save-section-8"></input>
  <!-- <a id="submitSectionButton8" class="progression"  href="submit-report-9.php">Next ></a> -->
</div></form>
  </div>
  <div class="overlay">
    <p></p>
