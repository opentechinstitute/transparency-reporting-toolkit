...
<table>
  ...
  <tbody>
    <tr >
      ...
      <td>
        <input type="text" name="pens-total" readonly="readonly" class="disabled"></input>
      </td>
    </tr>
    <tr class="disabled">
      <td>
      ...
      <td>
        <input type="text" readonly="readonly" name="pens-pc-rejected"></input>
      </td>
      <td>
        <input type="text" readonly="readonly" name="pens-pc-no-data"></input>
      </td>
      <td>
        <input type="text" readonly="readonly" name="pens-pc-content-disclosed"></input>
      </td>
      <td>
        <input type="text" readonly="readonly" name="pens-pc-non-content-disclosed"></input>
      </td>
      <td>
        <input type="text" name="pens-pc-total" readonly="readonly" value=100></input>
      </td>
    </tr>
