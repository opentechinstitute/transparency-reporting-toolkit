...
<form name="submitSection2" method="post" action="submit-report-3.php">
...
<table>
  ...
  <tbody>
    <tr >
      ...
      <td>
        <input type="text" name="wiretap-total" readonly="readonly" class="disabled"></input>
      </td>
    </tr>
    <tr class="disabled">
      <td>
      ...
      <td>
        <input type="text" readonly="readonly" name="wiretap-pc-rejected"></input>
      </td>
      <td>
        <input type="text" readonly="readonly" name="wiretap-pc-no-data"></input>
      </td>
      <td>
        <input type="text" readonly="readonly" name="wiretap-pc-content-disclosed"></input>
      </td>
      <td>
        <input type="text" readonly="readonly" name="wiretap-pc-non-content-disclosed"></input>
      </td>
      <td>
        <input type="text" name="wiretap-pc-total" readonly="readonly" value=100></input>
      </td>
    </tr>
...
<div class="progress-buttons">
  <a href="submit-report-1.php" class="progression ">&lt; Back</a>
  <input type="submit" class="progression" name="save-section-2" value=" Next >" id="save-section-2"></input>
  <!-- <a id="submitSectionButton2" class="progression"  href="submit-report-3.php">Next ></a> -->
</div></form>
  </div>
  <div class="overlay">
    <p></p>
