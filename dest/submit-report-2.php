...
<table>
  ...
  <tbody>
    <tr >
      ...
      <td>
        <input type="text" name="wiretap-total" disabled="true" value=0></input>
      </td>
    </tr>
    <tr class="disabled">
      <td>
      ...
      <td>
        <input type="text" disabled="true" name="wiretap-pc-rejected"></input>
      </td>
      <td>
        <input type="text" disabled="true" name="wiretap-pc-no-data"></input>
      </td>
      <td>
        <input type="text" disabled="true" name="wiretap-pc-content-disclosed"></input>
      </td>
      <td>
        <input type="text" disabled="true" name="wiretap-pc-non-content-disclosed"></input>
      </td>
      <td>
        <input type="text" name="wiretap-pc-total" disabled="true" value=100%></input>
      </td>
    </tr>
