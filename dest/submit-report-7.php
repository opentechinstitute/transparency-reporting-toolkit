...
<table>
  ...
  <tbody>
    <tr >
      ...
      <td>
        <input type="text" name="emergency-rejected" required></input>
      </td>
      <td>
        <input type="text" name="emergency-no-data" required></input>
      </td>
      <td>
        <input type="text" name="emergency-content-disclosed" required></input>
      </td>
      <td>
        <input type="text" name="emergency-non-content-disclosed" required></input>
      </td>
      <td>
        <input type="text" name="emergency-total" readonly="readonly" class="disabled"></input>
      </td>
    </tr>
    <tr class="disabled">
      <td>
      ...
      <td>
        <input type="text" readonly="readonly" name="emergency-pc-rejected"></input>
      </td>
      <td>
        <input type="text" readonly="readonly" name="emergency-pc-no-data"></input>
      </td>
      <td>
        <input type="text" readonly="readonly" name="emergency-pc-content-disclosed"></input>
      </td>
      <td>
        <input type="text" readonly="readonly" name="emergency-pc-non-content-disclosed"></input>
      </td>
      <td>
        <input type="text" name="emergency-pc-total" readonly="readonly" value=100></input>
      </td>
    </tr>
