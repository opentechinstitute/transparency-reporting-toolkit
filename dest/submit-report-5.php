...
<table>
  ...
  <tbody>
    <tr >
      ...
      <td>
        <input type="text" name="criminal-rejected" ></input>
      </td>
      <td>
        <input type="text" name="criminal-no-data" ></input>
      </td>
      <td>
        <input type="text" name="criminal-content-disclosed" ></input>
      </td>
      <td>
        <input type="text" name="criminal-non-content-disclosed" ></input>
      </td>
      <td>
        <input type="text" name="criminal-total" disabled="true" value=0></input>
      </td>
    </tr>
    <tr class="disabled">
      <td>
      ...
      <td>
        <input type="text" disabled="true" name="criminal-pc-rejected"></input>
      </td>
      <td>
        <input type="text" disabled="true" name="criminal-pc-no-data"></input>
      </td>
      <td>
        <input type="text" disabled="true" name="criminal-pc-content-disclosed"></input>
      </td>
      <td>
        <input type="text" disabled="true" name="criminal-pc-non-content-disclosed"></input>
      </td>
      <td>
        <input type="text" name="criminal-pc-total" disabled="true" value=100%></input>
      </td>
    </tr>
...
<div class="progress-buttons">
  ...
  <input type="submit" name="save-section-5" value="Save" id="save-section-5"></input>
  <a class="progression"  href="submit-report-6.php">Next &gt;</a>
</div>  </div>
  <div class="overlay">
    <p></p>
